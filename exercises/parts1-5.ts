...
//console.log(`${spacecraftName} woud take ${getDaysToLocation(kilometersToMars)} days to get to Mars.`);

//console.log(`${spacecraftName} woud take ${getDaysToLocation(kilometersToTheMoon)} days to get to the Moon.`);
